...
export default function EcoModal() {
	...
	return (
		<>
			...
			>
				<div className="border-border rounded border px-3 py-1 group-hover:border-2">
					<span className="text-muted-foreground text-lg group-hover:font-medium">Label</span>
				</div>
				<div className="text-muted-foreground text-center group-hover:font-medium">
					<span>Label éco conception interne</span>
				</div>
			</button>
